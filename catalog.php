        ...
        <div class="page">
            <div class="page-wrapper">
                <div class="page-wrapper-head">
                    <div class="page-wrapper-head-crumbs">
                        <a href="#">Сайт</a>
                        <a href="#">Каталог</a>
                    </div>
                    <h1>Кухни</h1>
                    <div class="page-wrapper-head-wrapper">
                        <div class="page-wrapper-head-wrapper-category">
                            <a href="#">Все</a>
                            <a href="#" class="active">Модерн</a>
                            <a href="#">Классика</a>
                            <a href="#">Хайтек</a>
                        </div>
                        <div class="page-wrapper-head-wrapper-count">
                            <strong>58</strong><span>моделей</span>
                        </div>
                        <div class="page-wrapper-head-wrapper-filter">
                            <a href="#">Используемые материалы</a>
                        </div>
                    </div>
                </div>
                <div class="page-wrapper-products">

                    <div class="page-wrapper-products-item">
                        <div class="page-wrapper-products-item-img" style="background-image: url('https://img2.goodfon.ru/wallpaper/big/9/c8/kukhnia-interer-villa-stil.jpg')"></div>
                        <div class="page-wrapper-products-item-data">
                            <strong>Арт-модерн Аделина</strong>
                            <span>от 180 000 руб.</span>
                        </div>
                    </div>

                    <div class="page-wrapper-products-item">
                        <div class="page-wrapper-products-item-img" style="background-image: url('https://img1.goodfon.ru/wallpaper/big/e/43/interer-komnata-stolovaia-kukhnia.jpg')"></div>
                        <div class="page-wrapper-products-item-data">
                            <strong>Арт-модерн Виктория</strong>
                            <span>от 140 000 руб.</span>
                        </div>
                    </div>

                    <div class="page-wrapper-products-item">
                        <div class="page-wrapper-products-item-img" style="background-image: url('https://img3.goodfon.ru/wallpaper/big/6/cd/interer-kukhnia-mebel-chasy-liustra.jpg')"></div>
                        <div class="page-wrapper-products-item-data">
                            <strong>Классика Анжелика</strong>
                            <span>от 540 000 руб.</span>
                        </div>
                    </div>

                    <div class="page-wrapper-products-item">
                        <div class="page-wrapper-products-item-img" style="background-image: url('https://img3.goodfon.ru/wallpaper/big/9/a1/interer-dizan-kukhnia.jpg')"></div>
                        <div class="page-wrapper-products-item-data">
                            <strong>Классика Ромашка</strong>
                            <span>от 240 000 руб.</span>
                        </div>
                    </div>

                    <div class="page-wrapper-products-item">
                        <div class="page-wrapper-products-item-img" style="background-image: url('https://img3.goodfon.ru/wallpaper/big/2/89/interer-komnata-kukhnia.jpg')"></div>
                        <div class="page-wrapper-products-item-data">
                            <strong>Классика Хай-тек</strong>
                            <span>от 240 000 руб.</span>
                        </div>
                    </div>

                    <div class="page-wrapper-products-item">
                        <div class="page-wrapper-products-item-img" style="background-image: url('https://img3.goodfon.ru/wallpaper/big/a/9a/dizain-komnata-interer-kukhnia-stil.jpg')"></div>
                        <div class="page-wrapper-products-item-data">
                            <strong>АРТ-Модерн Хай-арай</strong>
                            <span>от 340 000 руб.</span>
                        </div>
                    </div>
            ...
            <div class="footer-data">
                ...
                <div class="footer-data-febox">
                    <div class="footer-content-de-febox">
                        ...
                        <span>Все материалы сайта являются <br>объектами авторского права</span>
                    </div>
                </div>
            </div>
        </footer>
