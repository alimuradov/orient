            ...
            <div class="page-wrapper">
                <div class="page-wrapper-head">
                    <div class="page-wrapper-head-crumbs">
                        <a href="#">Сайт</a>
                        <a href="#">Каталог</a>
                        <a href="#">Антонио Конте</a>
                    </div>
                    <h1>Схема 4-3-3 "Фентези"</h1>

                </div>
                <div class="page-wrapper-open">
                    ...
                    <div class="fotorama" data-nav="thumbs">
                        <img src="/public/img/product/12.jpg">
                        <img src="/public/img/product/1.jpg">
                        <img src="/public/img/product/2.jpg">
                        <img src="/public/img/product/3.jpg">
                        <img src="/public/img/product/4.jpg">
                        <img src="/public/img/product/5.jpg">
                        <img src="/public/img/product/6.jpg">
                        <img src="/public/img/product/7.jpg">
                        <img src="/public/img/product/8.jpg">
                        <img src="/public/img/product/9.jpg">
                        <img src="/public/img/product/11.jpg">
                    </div>

                    <!-- 3. Enjoy! -->

                    <div class="page-wrapper-open-html">
                        <p><strong>СТОЛЕЩНИЦЫ</strong></p>
                        <p></p>
                        <p>ЛСДП 18мм кромка АБС.</p>
                        <p><strong>Цвет столещниц:</strong> снежно-белый, дымчато-серый, дуб, орех Каналлето</p>
                        <p></p>
                        <p><strong>МЕТАЛЛИЧЕСКИЕ ОПОРЫ</strong></p>
                        <p>П-образный формы из стальной трубы квадратного сечения 35*35.</p>
                        <p>Предлагается так же опоры Т-образной формы из стальной трубы круглого сечения. Возможно использовать опоры с регулировкой по высоте от 65 до 85 см.</p>
                        <p></p>
                        <p><strong>ЭКРАНЫ</strong></p>
                        <p>ЛДСП 18мм с закругленными краями, кромка АБС.</p>
                        <p><strong>Цвета экранов:</strong> аналогичные цвету столешниц, а также же зеленый или желтый, либо – прозрачный акрил 10мм.</p>
                        <p>Особенность серии — экстрадлинная единая столешница рабочего стола на 360см.</p>
                    </div>

                    <div class="page-wrapper-open-form">
                        <strong>ЗАКАЗАТЬ «КОЛЛЕКЦИЯ FRAMEWORK 2.0»</strong>
                        ...
                        <div class="page-wrapper-open-form-data">
                            <form>
                                <div class="page-wrapper-open-form-data-left">
                                    <span>Имя:</span>
                                    <input type="text">
                                    <span>Телефон:</span>
                                    <input type="text">
                                ...
                                <div class="page-wrapper-open-form-data-right">
